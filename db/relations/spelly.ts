...
import { profilesInSpelly, lobbiesInSpelly, lobbyPlayersInSpelly, lobbyPrevRoundsInSpelly } from "../schema/spelly";
...
export const lobbyPrevRoundsInSpellyRelations = relations(lobbyPrevRoundsInSpelly, ({one}) => ({
